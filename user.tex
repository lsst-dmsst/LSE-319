...
The \textbf{JupyterLab} aspect, based on the Jupyter family of technologies (such as JupyterHub and JupyterLab), 
...
A screen capture of a mature prototype of JupterLab is shown in Figure~\ref{fig:JupyterLab}.
