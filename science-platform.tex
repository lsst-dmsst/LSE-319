...
\begin{enumerate}
	...
	\item Integration of the initial Firefly front- and back-ends with LSP backend services. For example, this includes the authentication and authorization mechanisms, relational databases, file stores, etc.
